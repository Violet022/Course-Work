...
import PositionApplicationActions from "../../../components/tables/TableCellContent/PositionApplicationActions";
...
const positionApplicationsTableColumns: TableColumnsType<ShortStudentApplicationInfo> = [
    ...
    { title: 'Действия', key: 'actions',
        render: (_, record) => {
            return <PositionApplicationActions applicationInfo={record}/>
        }
    },
];
                    ...
                    expandable={{
                        ...
                        <>
                            <div style={{paddingInline: 32}}>
                                ...
                                <Table
                                    style={{marginTop: 4, maxWidth: 900}}
